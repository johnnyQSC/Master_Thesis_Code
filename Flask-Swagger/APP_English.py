...
model=torch.load('bert_model_english.pth', map_location=device)
model.eval()
#創建分詞器對象
tokenizer=BertTokenizer.from_pretrained('bert-base-uncased')
#定義API路徑
@app.route('/English-Fact-Checking',methods=['GET']) 
def EnglishFactChecking():
